        ...
        <div class="swiper-wrapper">
            <div class="swiper-slide">
                <a href="<?= BASE_URL ?>san-pham?category=gaming" class="hero-slide-link">
                    <img src="<?= ASSETS_URL ?>/images/banners/thang_04_pc_banner_web_collection_1920x420.jpg"
                        alt="PC Gaming Collection" class="hero-banner-img">
                </a>
            </div>
            <div class="swiper-slide">
                <a href="<?= BASE_URL ?>san-pham?sale=1" class="hero-slide-link">
                    <img src="<?= ASSETS_URL ?>/images/banners/gearvn-pc-gvn-rtx-5060-t9-header-banner.png"
                        alt="RTX 5060" class="hero-banner-img">
                </a>
            </div>
            <div class="swiper-slide">
                <a href="<?= BASE_URL ?>san-pham?category=laptop" class="hero-slide-link">
                    <img src="<?= ASSETS_URL ?>/images/banners/gearvn-laptop-gaming-t8-header-banner.png"
                        alt="Laptop Gaming" class="hero-banner-img">
                </a>
            </div>
        </div>
        ...
        <div class="row g-3">
            <div class="col-lg-3 col-md-3 col-6">
                <a href="<?= BASE_URL ?>san-pham?category=pc" class="small-banner-link">
                    <img src="<?= ASSETS_URL ?>/images/banners/gearvn-build-pc-slider-right-t8.png" alt="Build PC"
                        class="small-banner-img">
                </a>
            </div>
            <div class="col-lg-3 col-md-3 col-6">
                <a href="<?= BASE_URL ?>san-pham?category=pc-amd" class="small-banner-link">
                    <img src="<?= ASSETS_URL ?>/images/banners/gearvn-pc-amd-sub-t8.png" alt="PC AMD"
                        class="small-banner-img">
                </a>
            </div>
            <div class="col-lg-3 col-md-3 col-6">
                <a href="<?= BASE_URL ?>san-pham?category=laptop-gaming" class="small-banner-link">
                    <img src="<?= ASSETS_URL ?>/images/banners/gearvn-laptop-gaming-slider-bot-t8.png"
                        alt="Laptop Gaming" class="small-banner-img">
                </a>
            </div>
            <div class="col-lg-3 col-md-3 col-6">
                <a href="<?= BASE_URL ?>san-pham?category=laptop-van-phong" class="small-banner-link">
                    <img src="<?= ASSETS_URL ?>/images/banners/gearvn-laptop-van-phong-slider-bot-t8.png"
                        alt="Laptop Văn Phòng" class="small-banner-img">
                </a>
            </div>
            <div class="col-lg-3 col-md-3 col-6">
                <a href="<?= BASE_URL ?>san-pham?category=ban-phim" class="small-banner-link">
                    <img src="<?= ASSETS_URL ?>/images/banners/gearvn-ban-phim-slider-right-t8.png" alt="Bàn Phím"
                        class="small-banner-img">
                </a>
            </div>
            <div class="col-lg-3 col-md-3 col-6">
                <a href="<?= BASE_URL ?>san-pham?category=gaming-gear" class="small-banner-link">
                    <img src="<?= ASSETS_URL ?>/images/banners/gearvn-gaming-gear-sub-t8.png" alt="Gaming Gear"
                        class="small-banner-img">
                </a>
            </div>
            <div class="col-lg-3 col-md-3 col-6">
                <a href="<?= BASE_URL ?>san-pham?category=man-hinh" class="small-banner-link">
                    <img src="<?= ASSETS_URL ?>/images/banners/gearvn-man-hinh-sub-t8.png" alt="Màn Hình"
                        class="small-banner-img">
                </a>
            </div>
            <div class="col-lg-3 col-md-3 col-6">
                <a href="<?= BASE_URL ?>san-pham?sale=1" class="small-banner-link">
                    <img src="<?= ASSETS_URL ?>/images/banners/gearvn-gaming-gear-deal-hoi-sub-banner-t8.png"
                        alt="Gaming Gear Deal" class="small-banner-img">
                </a>
            </div>
        </div>
    </div>
                ...
                <div class="col-lg-2 col-md-4 col-6 mb-4" data-aos="fade-up" data-aos-delay="<?= $index * 50 ?>">
                    <a href="<?= BASE_URL ?>products?category=<?= $category['id'] ?>" class="category-card">
                        <div class="category-icon">
                            ...
                            ?>
                            <img src="<?= BASE_URL ?>img-danhmuc/<?= $imageName ?>" alt="<?= $category['name'] ?>"
        ...
        <div class="row">
            <div class="col-md-6 mb-4" data-aos="fade-right">
                <a href="#" class="banner-ad">
                    <img src="<?= BASE_URL ?>img-banner-gaming/1646813329_slider_1.jpg" alt="Banner"
            ...
            <div class="col-md-6 mb-4" data-aos="fade-left">
                <a href="#" class="banner-ad">
                    <img src="<?= BASE_URL ?>img-banner-gaming/gaming-computer-black-friday-super-sale-social-media-post-design-template_1101054-31250.avif"
